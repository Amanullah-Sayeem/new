...
from users.forms import MedicalInfoForm
from users.models import Action, Account, MedicalInfo
...
def list_view(request):
    ...
    return render(request, 'page/medicalinfo/list.html', template_data)
...
def update_view(request):
    ...
    template_data['form'] = form
    return render(request, 'page/medicalinfo/update.html', template_data)
...
def patient_view(request):
    ...
    form.disable_field('patient')
    template_data['form'] = form
    return render(request, 'page/medicalinfo/patient.html',template_data)