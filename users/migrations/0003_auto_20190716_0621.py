# Generated by Django 2.2.2 on 2019-07-16 00:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefHospital', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Hospital')),
            ],
        ),
        migrations.CreateModel(
            name='Prescription',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications_all', to='users.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages_sent', to='users.Account')),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages_received', to='users.Account')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalTest',
