...
from users.models import Account, Appointment, Action
...
def cancel_view(request):
    ...
    if request.method == 'POST':
        if 'yes' in request.POST:
            ...
            return HttpResponseRedirect('/appointment/list/')
    return render(request, 'page/appointment/cancel.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'page/appointment/list.html', template_data)
...
def update_view(request):
    ...
    template_data['form'] = form
    return render(request, 'page/appointment/update.html', template_data)
...
def create_view(request):
    ...
    if request.user.account.role == Account.ACCOUNT_PATIENT:
        ...
        form.disable_field('doctor')
    template_data['form'] = form
    return render(request, 'page/appointment/create.html', template_data)