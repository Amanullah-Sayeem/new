...
from users.forms import PasswordForm, ProfileForm
...
def profile_view(request):
    ...
    return render(request, 'page/profile.html', template_data)
...
def update_view(request):
    ...
    template_data['form'] = form
    return render(request, 'page/profile/update.html', template_data)