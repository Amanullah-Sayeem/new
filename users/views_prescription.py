...
from users.models import Account, Prescription, Action
...
def create_view(request):
    ...
    return render(request, 'page/prescription/create.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'page/prescription/list.html', template_data)
...
def delete_view(request):
    ...
    if request.method == 'POST':
        if 'yes' in request.POST:
            ...
            return HttpResponseRedirect('/prescription/list/')
    return render(request, 'page/prescription/delete.html', template_data)