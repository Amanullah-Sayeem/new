...
class Profile(models.Model):
    ...
    prefHospital = models.ForeignKey(Hospital,on_delete=models.CASCADE, null=True)
...
class Message(models.Model):
    target = models.ForeignKey(Account,on_delete=models.CASCADE, related_name="messages_received")
...
class Notification(models.Model):
    user = models.ForeignKey(Account,on_delete=models.CASCADE, related_name="notifications_all")
...
class MedicalTest(models.Model):
    ...
    hospital = models.ForeignKey(Hospital,on_delete=models.CASCADE,)
    description = models.CharField(max_length=200)
    doctor = models.ForeignKey(User,on_delete=models.CASCADE, related_name="docs")
    patient = models.ForeignKey(User,on_delete=models.CASCADE, related_name="pts")
