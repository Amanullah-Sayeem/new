...
from users.forms import AdmissionForm
from users.models import Account, Admission, Action
...
def admit_view(request):
    ...
    return render(request, 'page/admission/admit.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'page/admission/list.html', template_data)
...
def discharge_view(request):
    ...
    if request.method == 'POST':
        if 'yes' in request.POST:
            ...
            return HttpResponseRedirect('/admission/list/')
    return render(request, 'page/admission/discharge.html', template_data)