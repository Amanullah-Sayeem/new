...
from users.forms import EmployeeRegisterForm
from users.models import Account, Profile, Action
...
def users_view(request):
    ...
    return render(request, 'page/admin/users.html', template_data)
...
def activity_view(request):
    ...
    return render(request, 'page/admin/activity.html', template_data)
...
def createemployee_view(request):
    ...
    return render(request, 'page/admin/createemployee.html', template_data)
...
def statistic_view(request):
   # Authentication check.
    ...
    if 'sort' in request.GET:
        ...
        if request.GET['sort'] == 'type':
            template_data['query'] = Action.objects.all().order_by('type', 'description', '-timePerformed')
    return render(request, 'page/admin/stats.html', template_data)
