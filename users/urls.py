...
from users import views_admission
from users import views_appointment
from users import views_medtest
from users import views_message
from users import views_prescription
from users import views_profile
from users import views_medicalInfo
