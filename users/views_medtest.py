...
from users.forms import MedTestForm
from users.models import Account, Action, MedicalTest
...
def create_view(request):
    ...
    return render(request, 'page/medtest/upload.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'page/medtest/list.html', template_data)
...
def display_view(request):
    ...
    return render(request, 'page/medtest/display.html', template_data)
...
def update_view(request):
    ...
    if request.user.account.role == Account.ACCOUNT_DOCTOR:
        form.disable_field('doctor')
    template_data['form'] = form
    return render(request, 'page/medtest/update.html', template_data)